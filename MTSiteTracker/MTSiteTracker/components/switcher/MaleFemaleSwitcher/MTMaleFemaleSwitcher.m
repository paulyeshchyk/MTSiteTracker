...
#import "MTMaleFemaleSwitcher.h"

@interface MTMaleFemaleSwitcher ()
...
@implementation MTMaleFemaleSwitcher
...
- (void)awakeFromNib {
    [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([MTMaleFemaleSwitcher class]) owner:self options:nil];
